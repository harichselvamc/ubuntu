...
#     if head and body:
#         head_filename = secure_filename(head.filename)
#         body_filename = secure_filename(body.filename)
#         head_file_path = os.path.join(TEMP_FOLDER, head_filename)
#         body_file_path = os.path.join(TEMP_FOLDER, body_filename)

#         with open(head_file_path, "wb") as head_image:
#             head_image.write(await head.read())

#         with open(body_file_path, "wb") as body_image:
#             body_image.write(await body.read())

#         # Process the files
#         head_processed_file_path = os.path.join(TEMP_FOLDER, f"processed_{head_filename}")
#         body_processed_file_path = os.path.join(TEMP_FOLDER, f"processed_{body_filename}")

#         head_image = Image.open(head_file_path)
#         head_image = head_image.convert("RGB")
#         head_image.save(head_processed_file_path, format='JPEG')

#         img = cv2.imread(body_file_path)
#         detector = dlib.get_frontal_face_detector()
#         predictor = dlib.shape_predictor("shape_predictor_68_face_landmarks.dat")
...
#         output_filename = os.path.splitext(head_filename)[0] + '_processed.jpg'
...
# os.makedirs(BG_REM, exist_ok=True)
...
#             head_img = cv2.imread(head_processed_file_path)
#             head_img = cv2.resize(head_img, (max_x - min_x, max_y - min_y))
#             img[min_y:max_y, min_x:max_x] = head_img

#         cv2.imwrite(body_processed_file_path, img)
...
#         if 'User-Agent' in request.headers and 'Mozilla' in request.headers['User-Agent']:
#             output_link = f"http://localhost:8000/static/{output_filename}"
#             return RedirectResponse(url=output_link)
...
#     image_link = f"http://localhost:8000/static/{output_filename}.png"
#     return {"link": image_link}
...
#         image = convert_to_cartoon(file_path)
#     except Exception as e:
#         return {"error": f"Failed to convert image to cartoon: {str(e)}"}
...
#         output_file_path_relative = os.path.join(STATIC_FOLDER, output_filename)

#         cv2.imwrite(output_file_path, img)

#         if 'User-Agent' in request.headers and 'Mozilla' in request.headers['User-Agent']:
#             output_link = f"/static/{output_filename}"
#             return RedirectResponse(url=output_link)

#         image_link = f"/download/{output_filename}"
#         return JSONResponse(content={"image_link": image_link})
...
#     output_path = os.path.join(OUTPUT_FOLDER, f"{output_filename}.png")
#     download_path = os.path.join(DOWNLOAD_FOLDER, f"{output_filename}.png")
#     output_path_relative = os.path.join(STATIC_FOLDER, f"{output_filename}.png")
...
#     image_link = f"/static/{output_filename}.png"
#     return {"link": image_link}
...
#         # Process the files
#         head_processed_file_path = os.path.join(OUTPUT_FOLDER, "headandbody", f"processed_{head_filename}")
#         body_processed_file_path = os.path.join(OUTPUT_FOLDER, "headandbody", f"processed_{body_filename}")
...
#         output_filename = os.path.splitext(head_filename)[0] + '_processed.jpg'
#         output_file_path = os.path.join(OUTPUT_FOLDER, "headandbody", output_filename)
#         output_file_path_relative = os.path.join(STATIC_FOLDER, "headandbody", output_filename)
...
#     output_filename, _ = os.path.splitext(file.filename)
#     output_path = os.path.join(OUTPUT_FOLDER, "removebackground", f"{output_filename}.png")
#     download_path = os.path.join(DOWNLOAD_FOLDER, "removebackground", f"{output_filename}.png")
#     output_path_relative = os.path.join(STATIC_FOLDER, "removebackground", f"{output_filename}.png")
...
#     image_link = f"/static/removebackground/{output_filename}.png"
#     return {"link": image_link}
...
#     output_filename, _ = os.path.splitext(file.filename)
#     output_path = os.path.join(OUTPUT_FOLDER, "resize", f"{output_filename}.png")
#     download_path = os.path.join(DOWNLOAD_FOLDER, "resize", f"{output_filename}.png")
#     output_path_relative = os.path.join(STATIC_FOLDER, "resize", f"{output_filename}.png")
...
#     image_link = f"/static/resize/{output_filename}.png"
#     return {"link": image_link}
...
#     output_filename, _ = os.path.splitext(file.filename)
#     output_path = os.path.join(OUTPUT_FOLDER, "cartoon", f"{output_filename}.png")
#     download_path = os.path.join(DOWNLOAD_FOLDER, "cartoon", f"{output_filename}.png")
#     output_path_relative = os.path.join(STATIC_FOLDER, "cartoon", f"{output_filename}.png")
...
#     image_link = f"/static/cartoon/{output_filename}.png"
#     return {"link": image_link}
...
# def create_folders():
#     os.makedirs(TEMP_FOLDER, exist_ok=True)
#     os.makedirs(os.path.join(OUTPUT_FOLDER, "removebackground"), exist_ok=True)
#     os.makedirs(os.path.join(OUTPUT_FOLDER, "resize"), exist_ok=True)
#     os.makedirs(os.path.join(OUTPUT_FOLDER, "cartoon"), exist_ok=True)
#     os.makedirs(DOWNLOAD_FOLDER, exist_ok=True)
#     os.makedirs(os.path.join(STATIC_FOLDER, "removebackground"), exist_ok=True)
#     os.makedirs(os.path.join(STATIC_FOLDER, "resize"), exist_ok=True)
#     os.makedirs(os.path.join(STATIC_FOLDER, "cartoon"), exist_ok=True)
...
#     output_filename, _ = os.path.splitext(file.filename)
#     output_path = os.path.join(OUTPUT_FOLDER, "resize", f"{output_filename}_resized.jpg")
#     download_path = os.path.join(DOWNLOAD_FOLDER, "resize", f"{output_filename}_resized.jpg")
#     output_path_relative = os.path.join(STATIC_FOLDER, "resize", f"{output_filename}_resized.jpg")
...
#     image_link = f"/static/resize/{output_filename}_resized.jpg"
#     return {"link": image_link}

# @app.post("/cartoonize")
# async def cartoonize_image_endpoint(file: UploadFile = File(...)) -> dict[str, str]:
#     create_folders()
...
#     output_filename, _ = os.path.splitext(file.filename)
#     output_path = os.path.join(OUTPUT_FOLDER, "cartoon", f"{output_filename}_cartoon.jpg")
#     download_path = os.path.join(DOWNLOAD_FOLDER, "cartoon", f"{output_filename}_cartoon.jpg")
#     output_path_relative = os.path.join(STATIC_FOLDER, "cartoon", f"{output_filename}_cartoon.jpg")
...
#     image_link = f"/static/cartoon/{output_filename}_cartoon.jpg"
#     return {"link": image_link}
...
async def resize_image_endpoint(file: UploadFile = File(...)) -> dict[str, str]:
    ...
    output_filename, _ = os.path.splitext(file.filename)
    output_path = os.path.join(OUTPUT_FOLDER, "resize", f"{output_filename}.jpg")
    download_path = os.path.join(DOWNLOAD_FOLDER, "resize", f"{output_filename}.jpg")
    output_path_relative = os.path.join(STATIC_FOLDER, "resize", f"{output_filename}.jpg")
    ...
    image_link = f"/static/resize/{output_filename}.jpg"
    return {"link": image_link}
...
async def convert_to_cartoon_endpoint(file: UploadFile = File(...)) -> dict[str, str]:
    ...
    output_filename, _ = os.path.splitext(file.filename)
    output_path = os.path.join(OUTPUT_FOLDER, "cartoon", f"{output_filename}.jpg")
    download_path = os.path.join(DOWNLOAD_FOLDER, "cartoon", f"{output_filename}.jpg")
    output_path_relative = os.path.join(STATIC_FOLDER, "cartoon", f"{output_filename}.jpg")
    ...
    image_link = f"/static/cartoon/{output_filename}.jpg"
    return {"link": image_link}
