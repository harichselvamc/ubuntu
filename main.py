...
# # # #     output_path = os.path.join(OUTPUT_FOLDER, f"{uuid.uuid4()}.png")
# # # #     with open(output_path, "wb") as f:
# # # #         f.write(image)

# # # #     return {"link": output_path}
...
# # # #     head_path = os.path.join(TEMP_FOLDER, f"{uuid.uuid4()}.png")
# # # #     with open(head_path, "wb") as f:
# # # #         f.write(await head.read())

# # # #     body_path = os.path.join(TEMP_FOLDER, f"{uuid.uuid4()}.png")
...
# #     image_link = f"http://localhost:8000/output/{output_filename}"
# #     return {"link": image_link}
...
# @app.get("/download/{file_path}")
# def download_file(file_path: str, response: Response):
#     image_path = os.path.join(OUTPUT_FOLDER, file_path)
#     response = RedirectResponse(url=f"file://{os.path.abspath(image_path)}")
#     return response
